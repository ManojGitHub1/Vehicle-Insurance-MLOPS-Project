...
class ModelTrainer:
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        try:
            ...
            # ✅ Convert metric artifact to dictionary
            ...
            report_dir = os.path.dirname(self.model_trainer_config.accuracy_file_path)
            os.makedirs(report_dir, exist_ok=True)
            with open(self.model_trainer_config.accuracy_file_path, "w") as report_file:
                yaml.dump(classification_report_dict, report_file, default_flow_style=False)

            logging.info("Saved final model object and Classification Report YAML.")

            # Create and return the ModelTrainerArtifact
            model_trainer_artifact = ModelTrainerArtifact(
                trained_model_file_path=self.model_trainer_config.trained_model_file_path,
                metric_artifact=metric_artifact,
                accuracy_file_path=self.model_trainer_config.accuracy_file_path
            )
